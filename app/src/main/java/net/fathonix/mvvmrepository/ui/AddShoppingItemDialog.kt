...
import net.fathonix.mvvmrepository.databinding.DialogAddShoppingItemBinding
        ...
        binding.apply {
            tvAdd.setOnClickListener {
                ...
                if (name.isEmpty() || amount.isEmpty()) {
                    Toast.makeText(context, "Please enter all of the information", Toast.LENGTH_SHORT).show()
